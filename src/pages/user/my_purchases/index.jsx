...
PurchasesPage.getLayout = function getLayout(page) {
    return <UserLayout>{page}</UserLayout>;
  };

const WrappedCheckoutPage = AuthGuard(PurchasesPage, { allowedRoles: ["user"] });

// Ensure `getLayout` is preserved
WrappedCheckoutPage.getLayout = PurchasesPage.getLayout;
